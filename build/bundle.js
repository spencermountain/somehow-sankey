var app = (function () {
    ...
    var toPath = function (source, target) {
      ...
      let xi = d3$1.interpolateNumber(x0, x1);
      let x2 = xi(curvature);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 64, 8, 1526);
    			...
    			add_location(div1, file, 65, 8, 1568);
    			...
    			add_location(div2, file, 58, 6, 1235);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file, 79, 8, 1880);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(79:6) {#each paths as path}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 56, 2, 1137);
    			add_location(g, file, 77, 4, 1840);
    			attr_dev(svg, "viewBox", svg_viewBox_value = "0,0," + /*width*/ ctx[0] + "," + /*height*/ ctx[1]);
    			attr_dev(svg, "width", /*width*/ ctx[0]);
    			attr_dev(svg, "height", /*height*/ ctx[1]);
    			add_location(svg, file, 76, 2, 1782);
    			set_style(div1, "position", "relative");
    			add_location(div1, file, 55, 0, 1102);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Sankey, Node: Node$2, Col });
    	return [];
    }
